...
/*:
 * @plugindesc メニューにサイドビューキャラを表示するプラグイン ver1.02
 * @author 道楽
 *
...
(function(ns) {
	...
	ns.Sprite_ActorMenu = (function() {
		...
		{
			this.startMotion(ns.Param.ActorMotionIdle);
		};

		Sprite_ActorMenu.prototype.startActiveMotion = function()
		{
			this.startMotion(ns.Param.ActorMotionActive);
		};
	...
	Window_MenuStatus.prototype.createActorSprites = function()
	{
		...
		{
			this._actorSprites[ii] = new ns.Sprite_ActorMenu;
	...
	{
		this._actorSprite = new ns.Sprite_ActorMenu;
